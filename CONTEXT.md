...
AdviceKit models the path from source material to human-reviewed client information. These terms define the public meaning shared by the Python and TypeScript implementations.
